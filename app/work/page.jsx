...
const projects = [
  {
    ...
    title: "project 1",
    Description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus sint architecto alias maxime voluptatem vero.",
    stack: [{ name: "Windforms" }, { name: "DevExpress" }, { name: "Html 5" }],
  ...
  },
  {
    ...
    Description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus sint architecto alias maxime voluptatem vero.",
    stack: [{ name: "Asp.Net" }, { name: "Css 3" }, { name: "Javascript" }],
    image: "/assets/work/phonebrand.png",
    live: "",
    github: "",
  },
  {
    ...
    image: "/assets/work/enrolment.png",
    live: "",
    github: "",
  },
];
                ...
                return (
                  <SwiperSlide key={index} className="w-full">
                    ...
                    >
                      {/* overlay */}
                      <div
                        className="absolute top-0 btton-0 w-full h-full bg-black/10 
                      z-10"
                      ></div>
                      {/* image */}
